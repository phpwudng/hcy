define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'content_manage/index' + location.search,
                    add_url: 'content_manage/add',
                    edit_url: 'content_manage/edit',
                    del_url: 'content_manage/del',
                    multi_url: 'content_manage/multi',
                    import_url: 'content_manage/import',
