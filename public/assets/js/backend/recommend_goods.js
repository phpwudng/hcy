define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'recommend_goods/index' + location.search,
                    add_url: 'recommend_goods/add',
                    edit_url: 'recommend_goods/edit',
                    del_url: 'recommend_goods/del',
                    multi_url: 'recommend_goods/multi',
                    import_url: 'recommend_goods/import',
