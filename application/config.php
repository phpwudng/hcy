...
return [
    ...
    'token'                  => [
        ...
        'type'     => 'Mysql',
        // 缓存前缀
        'key'      => 'TrsJhZ1gdA6bWcO73LkKtVXHiEe94uvo',
        // 加密方式
        'hashalgo' => 'ripemd160',
        // 缓存有效期 0表示永久缓存
        'expire'   => 0,
    ...
    'fastadmin'              => [
        ...
        //允许跨域的域名,多个以,分隔
        'cors_request_domain'   => 'localhost,127.0.0.1,www.youqibang.com,services-game.com,test.services-game.com,www.services-game.com,www.youqibang.com,api.youqibang.com,aaa.youqibang.com,youqibang.com,www.huichuangye.net,huichuangye.net,api.huichuangye.net',
        //版本号
